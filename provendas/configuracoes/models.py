...
class Configuracao(models.Model):
    ...
    cor_primaria = models.CharField(max_length=7, default="#ff970f")  # Cor padrão atualizada
    cor_secundaria = models.CharField(max_length=7, default="#ffcb0f")  # Cor padrão atualizada
