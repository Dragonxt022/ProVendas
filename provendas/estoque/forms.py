...
class ProdutoForm(forms.ModelForm):
    class Meta:
        model = Produto
        fields = ['codigo_barras', 'nome', 'descricao', 'preco_de_venda', 'preco_de_custo', 'quantidade_estoque', 'categoria', 'file', 'status']  # Inclua todos os campos necessários
        ...
        widgets = {
            ...
            'preco_de_custo': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Preço de custo', 'step': '0.01'}),
