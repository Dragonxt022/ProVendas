...
(function ($) {
  ...
  setTimeout(function () {
    const isDevelopment = false; // Altere para true se quiser habilitar os alertas em desenvolvimento
  
    if (isDevelopment && window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
